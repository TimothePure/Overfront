...
#include "Pickups/OFJumpPickup.h"

#include "Character/OverfrontCharacter.h"
#include "Components/OFBuffComponent.h"

AOFJumpPickup::AOFJumpPickup()
{
	PrimaryActorTick.bCanEverTick = false;
}

void AOFJumpPickup::OnSphereOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (AOverfrontCharacter* Character = Cast<AOverfrontCharacter>(OtherActor))
	{
		...
		{
			BuffComponent->StartJumpBuff(JumpZVelocity, BuffDuration);
		}
	}
	Destroy();
}
